...
# ^0.154.0 等价于 >=0.154.0 <0.155.0。所以顶层若是 0.155.x，codex-acp 会在自己的
# node_modules 里再嵌一份 0.154 的 @openai/codex —— 连同它 ~284 MB 的平台二进制。
# 实测：钉 0.154.0 去重后相关目录是 301 MB，不钉是 613 MB。
#
